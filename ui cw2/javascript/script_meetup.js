...
function displayMeetups(meetupData) {
    ...
    if (meetupData.length === 0) {
        meetupList.innerHTML = '<p>No meetups at the moment. Start your own!</p>';
    } else {
...
// function addMeetupToCalendar(meetup, calendar) {
//   // Validate meetup object
//   if (!(meetup instanceof Meetup)) {
//     console.error("Invalid meetup object provided. Please provide a Meetup instance.");
//     return;
//   }
//
...
//     id: meetup.id,
//     title: meetup.name,
//     start: new Date(meetup.date),
//     allDay: !meetup.time, // Set allDay to true if no time is provided
//     description: meetup.description,
//     url: meetup.link, // Set event URL if provided
//   });
// }
//
// addMeetupToCalendar(meetups[0], calendar);
